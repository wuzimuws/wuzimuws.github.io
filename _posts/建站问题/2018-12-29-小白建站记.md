...
域名成功链接到github，个人博客成功开通喽～真是一件值得庆祝的事儿！在此对用到的教程进行总结：<br/>
...
<br/> 
例如通过GitHub和Wordpress来建个人网站是两种不同的方式，前者提供空间并可直接生成网站，但后者需要单独的服务器/主机来构建运行环境等[具体待分析]，但如果不了解的话，就容易张冠李戴，进一步混乱思路，不利于问题的解决。<!-- more -->
...
![截图测试](http://p1trollkt.bkt.clouddn.com/15149778238185.jpg)
